  ...
  <body>
    ...
    <div id="mission" class="block">
      <div class="block-wrap">
        ...
        <div class="block-body padded">
          <p>
            <?=$its?> &egrave; un laboratorio creativo
            dove confrontarsi/collaborare per la realizzazione di progetti comuni o individuali.
          </p>
          <p>
            &Egrave; un luogo "in progress", con spazi e servizi dedicati e altri da costruire
            con le idee e secondo le necessit&agrave; di utilizzo di chi vorr&agrave; frequentarlo.
          </p>
          <p>
        ...
        <div class="block-body container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="media staff-profile">
                <div class="media-left">
                  <img class="img-circle" src="res/carlo.jpg" width="70" height="70">
                </div>
            ...
            <div class="col-md-5">
              <div class="media staff-profile">
                <div class="media-left">
                  <img class="img-circle" src="res/virginia.jpg" width="70" height="70">
                </div>
                <div class="media-body">
                  <h4 class="media-heading fg-cyan">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="media staff-profile">
                <div class="media-left">
                  <img class="img-circle" src="res/marilisa.jpg" width="70" height="70">
                </div>
                <div class="media-body">
                  <h4 class="media-heading fg-cyan">
            ...
            <div class="col-md-5">
              <div class="media staff-profile">
                <div class="media-left">
                  <img class="img-circle" src="res/chiara.jpg" width="70" height="70">
                </div>
                <div class="media-body">
                  <h4 class="media-heading fg-cyan">
          ...
          <div class="row">
            ...
            <div class="col-md-5">
              <div class="media staff-profile">
                <div class="media-left">
                  <img class="img-circle" src="res/nancy.jpg" width="70" height="70">  
                </div>
                <div class="media-body">
                  <h4 class="media-heading fg-cyan">
