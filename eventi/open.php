<div class="media event">
	...
	<div class="media-body">
		...
		<h5 class="media-heading">Officine Robotiche Open Days</h5>
		<p class="mb-20px">
			Hai gi&agrave; visitato la nuova sede di <a href="http://www.officinerobotiche.it" class="fg-orange" target="_new">Officine Robotiche</a>? Sei curioso di vedere il nostro laboratorio? Vuoi saperne di pi&ugrave; sui corsi? Desideri diventare un membro dell'associazione OR? Vieni a trovarci! <a href="#" class="more-info">Altro...</a>
		</p>
		<div class="hidden event-info">
			...
			<p class="mb-20px">Ti aspettiamo!</p>
